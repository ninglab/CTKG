...
Each *term* node represents a normalized or standard drug name. CTKG includes 2,588 *term* nodes. Each *term* node has an id "TermID:XXX" and 1 attribute.
